...
### 시나리오 2: 전화번호만 있는 경우
사용자: "+82 2-1234-5678로 전화해줘"
→ 수집: target_phone="+82 2-1234-5678"
→ 응답: "전화번호 확인했어요! 📞
...
### 시나리오 3: 모든 정보 한 번에
사용자: "+82 2-1234-5678로 전화해서 역삼동 OO아파트 101동 1001호 아직 있는지 확인해줘"
→ 수집: target_phone="+82 2-1234-5678", special_request="역삼동 OO아파트 101동 1001호 매물 존재 여부 확인"
→ 응답: "거의 다 됐어요! 👍
...
export const PROPERTY_FEW_SHOT_EXAMPLES = [
  ...
  {
    role: 'assistant' as const,
    content: `{"message":"완벽해요! 정리해볼게요 📋\\n\\n📍 **직방 매물**\\n📞 +82 2-1234-5678\\n🏠 매물: 강남역 OO빌라 201호\\n❓ 확인: 매물 존재 여부\\n\\n✅ 맞으면 **전화 걸기** 버튼을 눌러주세요!\\n✏️ 수정할 게 있으면 말씀해주세요!","collected":{"target_name":"직방 매물","target_phone":"+82 2-1234-5678","scenario_type":"INQUIRY","scenario_sub_type":"PROPERTY","special_request":"강남역 OO빌라 201호 매물 존재 여부 확인"},"is_complete":true,"detected_intent":{"scenario_type":"INQUIRY","scenario_sub_type":"PROPERTY","confidence":1.0}}`,
  },
  // 예시 4: 한 번에 모든 정보
  {
    role: 'user' as const,
    content: '+82 2-9999-8888로 전화해서 역삼동 OO아파트 101동 1001호 아직 있는지 확인해줘',
  },
  {
    role: 'assistant' as const,
    content: `{"message":"거의 다 됐어요! 👍\\n\\n부동산 이름을 알려주시거나:\\n1️⃣ 직방 매물이에요\\n2️⃣ 다방 매물이에요\\n3️⃣ 네이버 부동산이에요\\n4️⃣ 모르겠어요 (그냥 '부동산'으로 할게요)","collected":{"target_phone":"+82 2-9999-8888","scenario_type":"INQUIRY","scenario_sub_type":"PROPERTY","special_request":"역삼동 OO아파트 101동 1001호 매물 존재 여부 확인"},"is_complete":false,"detected_intent":{"scenario_type":"INQUIRY","scenario_sub_type":"PROPERTY","confidence":1.0}}`,
  },
  // 예시 5: 모르겠어요 → 완료
  {
    role: 'user' as const,
  ...
  {
    role: 'assistant' as const,
    content: `{"message":"완벽해요! 정리해볼게요 📋\\n\\n📍 **부동산**\\n📞 +82 2-9999-8888\\n🏠 매물: 역삼동 OO아파트 101동 1001호\\n❓ 확인: 매물 존재 여부\\n\\n✅ 맞으면 **전화 걸기** 버튼을 눌러주세요!\\n✏️ 수정할 게 있으면 말씀해주세요!","collected":{"target_name":"부동산","target_phone":"+82 2-9999-8888","scenario_type":"INQUIRY","scenario_sub_type":"PROPERTY","special_request":"역삼동 OO아파트 101동 1001호 매물 존재 여부 확인"},"is_complete":true,"detected_intent":{"scenario_type":"INQUIRY","scenario_sub_type":"PROPERTY","confidence":1.0}}`,
  },
];
